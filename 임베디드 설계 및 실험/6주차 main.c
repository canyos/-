...
//@TODO - 3 RCC Setting
    ...
    /* UART Tx, Rx, MCO port */
    // Todo 3
    RCC->APB2ENR |= (uint32_t)(RCC_APB2ENR_IOPAEN | RCC_APB2ENR_IOPAEN);
...
//@TODO - 4 GPIO Configuration
    ...
    // Todo 4
    GPIOA->CRH |= (uint32_t)(GPIO_CRH_CNF9_1 | GPIO_CRH_MODE9) | (uint32_t)(GPIO_CRH_CNF10_1);
    ...
    // Todo 4
    GPIOC->CRL |= (uint32_t)GPIO_CRL_CNF4_1;
}
